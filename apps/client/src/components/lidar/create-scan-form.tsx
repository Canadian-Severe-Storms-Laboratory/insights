...
import { $createScan } from '@/lib/client';
    ...
    const form = useForm({
        ...
        onSubmit: async ({ value }) => {
            try {
                ...
                navigate({ to: '/lidar/new/$id/upload', params: { id: result.scan.id } });
            } catch (error) {
                const message =
                ...
                toast.error(`Failed to create path. ${detailedMessage?.data?.error?.message || message}`);
